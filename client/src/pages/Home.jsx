    ...
    return (
        <div className="min-h-screen bg-brand-secondary">
                ...
                <div className="relative z-10 container mx-auto px-6 text-center md:text-left">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold text-white mb-6 leading-tight font-display tracking-tight">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-primary">
                                Sur La Route
                            </span>
                        </h1>
                        <p className="text-lg md:text-xl text-zinc-300 mb-10 max-w-xl font-light leading-relaxed">
                            {tenant?.aboutText || "Découvrez une flotte exclusive pour vos déplacements à Rabat. Performance, transparence et service premium — le véhicule que vous réservez est exactement celui que vous recevez."}
                        </p>
                        <div className="flex flex-col md:flex-row gap-4">
                            <Link
                                to="/cars"
                                className="group bg-brand-primary hover:bg-brand-primary text-white font-bold py-4 px-8 rounded-none skew-x-[-10deg] transition-all duration-300 shadow-[0_0_20px_rgba(220,38,38,0.4)] hover:shadow-[0_0_30px_rgba(220,38,38,0.6)] flex items-center justify-center gap-2 border border-brand-primary/50"
                            >
            ...
            <section className="py-24 bg-zinc-50">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="text-brand-primary font-bold text-sm uppercase tracking-widest">La Promesse {tenant?.company?.name || 'Exact'}</span>
            ...
            <section className="py-24 bg-brand-secondary">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="text-brand-primary font-bold text-sm uppercase tracking-widest">Simple & Rapide</span>
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="text-brand-primary font-bold text-sm uppercase tracking-widest">Nos Services</span>
                        <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 mt-3 mb-4 font-display uppercase tracking-wider">
            ...
            <section className="relative py-20 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-brand-primary to-brand-primary"></div>
                ...
                <div className="relative z-10 container mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            to="/cars"
                            className="group bg-white text-brand-primary font-bold py-4 px-8 skew-x-[-10deg] transition-all duration-300 hover:bg-zinc-100 shadow-lg flex items-center justify-center"
                        >
                            <span className="skew-x-[10deg] flex items-center gap-2">
                                Réserver Maintenant
                        ...
                        <a
                            href={tenant?.contactPhone ? `tel:${tenant.contactPhone}` : "tel:+212663555666"}
                            className="bg-zinc-900 hover:bg-zinc-800 text-white font-semibold py-4 px-8 skew-x-[-10deg] transition-all duration-300 flex items-center justify-center"
                        >
                            <span className="skew-x-[10deg] flex items-center gap-2">
                                <Phone size={18} />
                                Appelez-Nous
...
const StepCard = ({ number, title, description, icon }) => (
    <div className="text-center group">
        ...
        <span className="text-brand-primary/40 text-4xl font-bold font-display">{number}</span>
